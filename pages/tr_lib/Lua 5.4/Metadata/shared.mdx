...
* resourceName?: `string` the name of the resource you want to get from

### Returns
* `string | table | nil`: the value of the attribute (when keys is a string) | a table containing key-value pairs (when keys is a table) | if the attribute doesn't exist
